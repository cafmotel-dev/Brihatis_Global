...
<body class="body-bg-1">
                    ...
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
                            ...
                            <div class="content-box">
                                <h3>Welcome to our Best Brihati Global employee & employer Company</h3>
                                <div class="inner-text">
                                    <p>
                                       Brihati Global connects employees and employers, delivering the best services to our customers. Meet our experienced and professional team, dedicated to providing outstanding customer service.
                                    </p>
                                </div>
                            </div>
                            <div class="sidebar-contact-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="inner">
                                            <div class="text">
                                                <p><a href=" bharti@bhritisglobal.com"> bharti@bhritisglobal.com</a></p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
    ...
    <div class="page-wrapper boxed_wrapper">
        ...
        <!--Main Slider Start-->
        <section class="main-slider main-slider-style2">
            <div class="main-slider-style2__inner">
                <div class="main-slider-style2__inner-container">
    ...
    <!--End Single Swiper Slide-->
                        ...
                        <div class="main-slider__nav">
                            <div class="swiper-button-prev" id="main-slider__swiper-button-next">
                                <i class="icon-left-arrow-angle-big-gross-symbol left"></i>
                            </div>
                            <div class="swiper-button-next" id="main-slider__swiper-button-prev">
                                <i class="icon-arrow-angle-pointing-to-right right"></i>
                            </div>
                        </div>
...
<!--Start Welcome Style1-->
            ...
            <div class="container">
                ...
                <ul class="row">
                    ...
                    <li class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-style2__single">
                            <div class="title-box">
                                <h3><a href="solution01-temporary-stafing.html">Temporary<br> Staffing</a></h3>
                            </div>
                            <div class="icon-box">
                                <div class="icon">
                    ...
                    <li class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-style2__single">
                            <div class="title-box">
                                <h3><a href="solution02-contract-stafing.html">Contract<br>Staffing</a></h3>
                            </div>
                            <div class="icon-box">
                                <div class="icon">
                    ...
                    <li class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-style2__single">
                            <div class="title-box">
                                <h3><a href="solution03-project-based.html">Project<br>Based Hiring</a></h3>
                            </div>
                            <div class="icon-box">
                                <div class="icon">
                    ...
                    <li class="col-xl-3 col-lg-6 col-md-6">
                        <div class="service-style2__single">
                            <div class="title-box">
                                <h3><a href="solution04-permanent-stafing.html">Permanent<br>Staffing</a></h3>
                            </div>
                            <div class="icon-box">
                                <div class="icon">
        ...
        <section class="case-style1" >
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="owl-carousel owl-theme thm-owl__carousel case-style1-carousel" data-owl-options='{
                            "loop": true,
                            "autoplay": true,
                            "margin": 30,
                            "nav": false,
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4">
                        <div class="why-choose-style1__inner">
                            <ul>
        ...
        <section class="testimonial-style2" style="background-color: #158c7f;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <div class="testimonial-style2__content">
                            <div class="sec-title">
                                <div class="sub-title">
                                    <h4>Testimonials</h4>
                                </div>
                            ...
                            <div class="blog-style2__form">
                                <form action="https://mehedi.asiandevelopers.com/2025/hiringhub/index.html" method="post">
                                    <div class="check-employer-box1">
                                        <ul>
                                            <li>
                                                <input type="radio" id="employer-yes" name="employer" checked="checked">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="blog-style2__single-content">
                                            ...
                                            <div class="blog-style2__single-btn">
                                                <p>2 Mins Read</p>
                                                <a href="blog-single.html">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="single-footer-widget mr60">
